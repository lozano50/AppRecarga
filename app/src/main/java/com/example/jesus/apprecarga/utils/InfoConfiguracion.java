...
public class InfoConfiguracion {
    ...
    /*public byte[] getDatosComoByteArray()
    {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        DataOutputStream dos = new DataOutputStream(baos);
        try
        {
            dos.writeUTF(strNombreEntidad);
            dos.writeUTF(strNroIdentificacion);
            dos.writeUTF(strDireccionEntidad);
            dos.writeUTF(strTelefonoEntidad);
            dos.writeUTF(strEncabezadoCierre1);
            dos.writeUTF(strEncabezadoCierre2);
            dos.writeUTF(strEncabezadoCierre3);
            dos.writeUTF(strEncabezadoCierre4);
            dos.writeUTF(strEncabezadoCierre5);
            dos.writeUTF(strPieDePaginaCierre1);
            dos.writeUTF(strPieDePaginaCierre2);
            dos.writeUTF(strPieDePaginaCierre3);
            dos.writeUTF(strPieDePaginaCierre4);
            dos.writeUTF(strPieDePaginaCierre5);
            dos.writeUTF(strGprsAPN);
            dos.writeUTF(strGprsUsuario);
            dos.writeUTF(strGprsPassword);
            dos.writeUTF(strGprsPPPTimeout);
            dos.writeUTF(strGprsPPPPermanente);
            dos.writeUTF(strGprsTCPPermanente);
            dos.writeUTF(strGprsIPPrimaria);
            dos.writeUTF(strGprsIPSecundaria);
            dos.writeUTF(strGprsPuertoPrimario);
            dos.writeUTF(strGprsPuertoSecundario);
            dos.writeUTF(strGprsSSL);
            dos.writeUTF(strDialupHostPrimario);
            dos.writeUTF(strDialupHostSecundario);
            dos.writeUTF(strDialupTimeoutRecarga);
            dos.writeUTF(strDialupTimeoutCierre);
            dos.writeUTF(strDialupTimeoutConsulta);
            dos.writeUTF(strSimboloMoneda);
            dos.writeUTF(strNumeroDecimales);
            dos.writeUTF(strSimboloDecimal);
            dos.writeUTF(strPassword);
            dos.writeUTF(strFechaDLC);
            dos.writeUTF(strVersionDLC);
            dos.writeUTF(strEncabezadoActivacion1);
            dos.writeUTF(strEncabezadoActivacion2);
            dos.writeUTF(strEncabezadoActivacion3);
            dos.writeUTF(strEncabezadoActivacion4);
            dos.writeUTF(strEncabezadoActivacion5);
            dos.writeUTF(strPiePaginaActivacion1);
            dos.writeUTF(strPiePaginaActivacion2);
            dos.writeUTF(strPiePaginaActivacion3);
            dos.writeUTF(strPiePaginaActivacion4);
            dos.writeUTF(strPiePaginaActivacion5);
            dos.writeUTF(strEncabezadoSaldo1);
            dos.writeUTF(strEncabezadoSaldo2);
            dos.writeUTF(strEncabezadoSaldo3);
            dos.writeUTF(strPiePaginaSaldo1);
            dos.writeUTF(strPiePaginaSaldo2);
            dos.writeUTF(strPiePaginaSaldo3);
            dos.writeInt(iNumOperadoras);
            if(strGprsSSL.equalsIgnoreCase("S"))
                dos.writeUTF(strCertificadoSSL);
        }
        catch(IOException e)
        {
            e.printStackTrace();
    ...
    /*public void setDatosDesdeByteArray(byte bDatos[])
    {
        ByteArrayInputStream bais = new ByteArrayInputStream(bDatos);
        DataInputStream dis = new DataInputStream(bais);
        try
        {
            strNombreEntidad = dis.readUTF();
            strNroIdentificacion = dis.readUTF();
            strDireccionEntidad = dis.readUTF();
            strTelefonoEntidad = dis.readUTF();
            strEncabezadoCierre1 = dis.readUTF();
            strEncabezadoCierre2 = dis.readUTF();
            strEncabezadoCierre3 = dis.readUTF();
            strEncabezadoCierre4 = dis.readUTF();
            strEncabezadoCierre5 = dis.readUTF();
            strPieDePaginaCierre1 = dis.readUTF();
            strPieDePaginaCierre2 = dis.readUTF();
            strPieDePaginaCierre3 = dis.readUTF();
            strPieDePaginaCierre4 = dis.readUTF();
            strPieDePaginaCierre5 = dis.readUTF();
            strGprsAPN = dis.readUTF();
            strGprsUsuario = dis.readUTF();
            strGprsPassword = dis.readUTF();
            strGprsPPPTimeout = dis.readUTF();
            strGprsPPPPermanente = dis.readUTF();
            strGprsTCPPermanente = dis.readUTF();
            strGprsIPPrimaria = dis.readUTF();
            strGprsIPSecundaria = dis.readUTF();
            strGprsPuertoPrimario = dis.readUTF();
            strGprsPuertoSecundario = dis.readUTF();
            strGprsSSL = dis.readUTF();
            strDialupHostPrimario = dis.readUTF();
            strDialupHostSecundario = dis.readUTF();
            strDialupTimeoutRecarga = dis.readUTF();
            strDialupTimeoutCierre = dis.readUTF();
            strDialupTimeoutConsulta = dis.readUTF();
            strSimboloMoneda = dis.readUTF();
            strNumeroDecimales = dis.readUTF();
            strSimboloDecimal = dis.readUTF();
            strPassword = dis.readUTF();
            strFechaDLC = dis.readUTF();
            strVersionDLC = dis.readUTF();
            strEncabezadoActivacion1 = dis.readUTF();
            strEncabezadoActivacion2 = dis.readUTF();
            strEncabezadoActivacion3 = dis.readUTF();
            strEncabezadoActivacion4 = dis.readUTF();
            strEncabezadoActivacion5 = dis.readUTF();
            strPiePaginaActivacion1 = dis.readUTF();
            strPiePaginaActivacion2 = dis.readUTF();
            strPiePaginaActivacion3 = dis.readUTF();
            strPiePaginaActivacion4 = dis.readUTF();
            strPiePaginaActivacion5 = dis.readUTF();
            strEncabezadoSaldo1 = dis.readUTF();
            strEncabezadoSaldo2 = dis.readUTF();
            strEncabezadoSaldo3 = dis.readUTF();
            strPiePaginaSaldo1 = dis.readUTF();
            strPiePaginaSaldo2 = dis.readUTF();
            strPiePaginaSaldo3 = dis.readUTF();
            iNumOperadoras = dis.readInt();
            if(strGprsSSL.equalsIgnoreCase("S"))
                strCertificadoSSL = dis.readUTF();
        }
